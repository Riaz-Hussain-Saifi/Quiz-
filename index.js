...
// Welcome message
let Developer = "Saifi Developer's";
let quiz = "Quiz";
console.log(chalk.blueBright(`\n Welcome to the ${chalk.yellowBright(Developer)} ${chalk.greenBright(quiz)} \n`));
...
const quizQuestions = [
    ...
    },
    {
        ...
        correctAnswer: "C. To create a variable that cannot be modified after its initial assignment",
    },
    {
        name: "Q9",
...
async function runQuiz() {
    ...
    console.log(chalk.blue(`\n\t Dear ${chalk.cyanBright(user.name)} age of ${chalk.green(user.age)}, you got ${chalk.greenBright(score / pointsPerQuestion)} out of ${chalk.yellowBright(quizQuestions.length)} correct!`));
    if (score >= passingScore) {
        console.log(chalk.greenBright(`\n\t Dear ${chalk.cyanBright(user.name)} age of ${chalk.green(user.age)} you are passed, your score is ${chalk.yellowBright(score)}.`));
    }
    else {
        console.log(chalk.redBright(`Dear ${chalk.cyanBright(user.name)} age of ${chalk.green(user.age)} you are failed, your score is ${chalk.yellowBright(score)}. You need a minimum score of ${chalk.greenBright(passingScore)} to pass. \n`));
    }
    console.log(chalk.bgMagenta(`\t\n\t\t Thank you for using ${chalk.bgGreenBright(Developer)} ${chalk.bgCyan(quiz)} \n`));
}
// Run the quiz
runQuiz();
